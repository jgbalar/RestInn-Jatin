...
import img2 from '../assets/resortImages/1.jpg'
import img3 from '../assets/resortImages/1.jpg'
import img4 from '../assets/resortImages/1.jpg'
import img5 from '../assets/resortImages/1.jpg'
const Hero = () => {
  return (
    <div className='hero'>
